...
func IsP1g() Middleware {
	return func(h http.HandlerFunc) http.HandlerFunc {
		return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			...
			if auth.GetGatekeeper().CheckRoleAndAuth(cookie.Value) >= variables.P1G {
				h.ServeHTTP(w, r)
				/*
